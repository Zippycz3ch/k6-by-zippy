...
export async function hartmannAkademieTest() {
  const testName = "hartmannAkademieTest";
  console.log(`--- Starting: ${testName} | ITER ${__ITER} | VU ${__VU} ---`);
  const page = await prepareUI();

  await page.goto(`${__ENV.K6_BASE_URL_HARTMANB2C}/learning-and-knowledge/hartmann-akademie`);
